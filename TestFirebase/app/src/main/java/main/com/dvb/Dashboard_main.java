        ...
        homeLay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!Constants.FRAGMENT_SELECTED.equalsIgnoreCase("home")) {
                    ...
                    if (DEFAULT_LAG.equalsIgnoreCase(l)){setActionBarTitle(getResources().getString(R.string.telugu_appname));
                    }else{setActionBarTitle(getResources().getString(R.string.app_name));}
...
//                FragmentManager manager = getSupportFragmentManager();
                    ...
                    transaction.commit();
                    String l = language.getText().toString();
                    if (DEFAULT_LAG.equalsIgnoreCase(l)){setActionBarTitle(getResources().getString(R.string.telugu_myreports));
                    }else{setActionBarTitle(getResources().getString(R.string.english_myReports));}
...
//                FragmentManager manager = getSupportFragmentManager();
                    ...
                    transaction.commit();
                    String l = language.getText().toString();
                    if (DEFAULT_LAG.equalsIgnoreCase(l)){setActionBarTitle(getResources().getString(R.string.telugu_report));
                    }else{setActionBarTitle(getResources().getString(R.string.english_report));}
        ...
        tourismLay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!Constants.FRAGMENT_SELECTED.equalsIgnoreCase("tourism")) {
                    ...
                    transaction.commit();
                    String l = language.getText().toString();
                    if (DEFAULT_LAG.equalsIgnoreCase(l)){setActionBarTitle(getResources().getString(R.string.telugu_tourism));
                    }else{setActionBarTitle(getResources().getString(R.string.english_tourism));}
